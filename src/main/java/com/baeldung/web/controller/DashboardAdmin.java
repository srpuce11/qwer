...
public class DashboardAdmin {
	...
	public String dashboardAdmin(Locale locale, final ModelMap model, HttpServletRequest request, HttpServletResponse response,
...
// Auth check
		 boolean isUser = false;
	        ...
	        if (isUser) {
	             ...
	             return "/dashboardUser.html?user="+username;// to userDashboard
	        } else if (isAdmin) {
